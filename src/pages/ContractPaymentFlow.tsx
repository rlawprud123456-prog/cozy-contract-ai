        ...
        {step === "sign" && (
          <Card className="p-6 border-0 shadow-lg">
            ...
            <div className="bg-muted/50 rounded-lg p-6 mb-6 min-h-[200px] flex items-center justify-center">
              <p className="text-muted-foreground text-sm">계약서 상세 내용 (생략)</p>
            </div>
          ...
          <Card className="p-6 border-0 shadow-lg">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                ...
                <span className="font-bold text-foreground">15,000,000원</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
        ...
        {step === "done" && (
          <Card className="p-6 border-0 shadow-lg">
            <div className="flex flex-col items-center text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mt-2">이제 안심하고 인테리어 공사를 시작하세요.</p>
            </div>
          </Card>
        )}
