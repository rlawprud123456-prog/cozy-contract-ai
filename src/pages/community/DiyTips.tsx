    ...
    <div className="min-h-[calc(100vh-180px)] bg-background p-3 sm:p-4">
      <div className="container mx-auto max-w-4xl py-4 sm:py-6 md:py-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
          <div className="px-2">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1 sm:mb-2">셀프인테리어 팁</h1>
            <p className="text-xs sm:text-sm md:text-base text-muted-foreground">직접 해보는 인테리어 노하우를 공유하세요</p>
          </div>
          <Button 
